        ...
        <div className="max-w-md w-full mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your employee registration has been submitted successfully. You will receive an email notification once an admin or HR manager approves your account.
            </p>
            <Link
              href="/login"
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form onSubmit={handleOtpSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors text-center text-2xl font-mono tracking-wider"
                  placeholder="123456"
                />
              </div>
            ...
            <div className="mt-6 text-center">
              ...
              <button
                onClick={resendOtp}
                disabled={isLoading}
                className="text-green-600 hover:text-green-700 font-medium underline disabled:text-green-400"
              >
